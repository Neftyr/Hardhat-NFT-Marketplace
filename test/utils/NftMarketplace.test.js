    ...
    : describe("Nft Marketplace Unit Tests", function () {
          ...
          describe("updateListing", function () {
              it("must be owner and listed", async function () {
                  ...
                  await nftMarketplace.listItem(basicNft.address, TOKEN_ID, PRICE)
                  nftMarketplace = nftMarketplaceContract.connect(user)
                  await expect(nftMarketplace.updateListing(basicNft.address, TOKEN_ID, PRICE)).to.be.revertedWith("NotOwner")
              })
          ...
          describe("withdrawProceeds", function () {
              ...
              it("withdraws proceeds", async function () {
                  ...
                  assert(deployerBalanceAfter.toString() == deployerProceedsBefore.add(deployerBalanceBefore).sub(gasCost).toString())
